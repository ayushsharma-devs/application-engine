...
if __name__ == "__main__":
    # Change this to match your actual resume filename
    RESUME_INPUT = "Ayush_Sharma_s_Resume (9).pdf" 
    
    OUTPUT_TXT = "resume_context.txt"
    OUTPUT_JSON = "profile_context.json"

    try:
        cleaned_profile = extract_and_clean_resume(RESUME_INPUT)
        export_context(cleaned_profile, OUTPUT_TXT, OUTPUT_JSON)
